...
#	* Removed explicit references to Pokemon as an individual species
#==============================================================================#
class Battle
  def pbGainExp
      ...
      if numPartic > 0 || expShare.length > 0 || expAll
        ...
        if expAll
          ...
          eachInTeam(0, 0) do |pkmn, i|
            ...
            pbDisplayPaused(_INTL("Your party members in waiting also got Exp. Points!")) if showMessage
            showMessage = false
            pbGainEVsOne(i, b)
...
#==============================================================================#
# Changes in this section include the following:
#	* Adding in a sound effect for leveling up that makes it more authentic
#==============================================================================#  
